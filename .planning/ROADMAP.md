...
- [x] 03-02-PLAN.md — YOLO/Compose hardening: overlay wiring, failure restore, cursor positioning (Wave 2)
- [x] 03-03-PLAN.md — Unit tests + manual verification on all 7 target editors (Wave 3)
